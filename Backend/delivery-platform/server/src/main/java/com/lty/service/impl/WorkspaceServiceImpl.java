...
import com.lty.vo.BusinessDataVO;
import com.lty.vo.DishOverViewVO;
import com.lty.vo.OrderOverViewVO;
import com.lty.vo.SetmealOverViewVO;
...
public class WorkspaceServiceImpl implements WorkspaceService {
    ...
    public BusinessDataVO getBusinessData(LocalDateTime begin, LocalDateTime end) {
        ...
        //查询总订单数
        Integer totalOrderCount = orderMapper.countOrder(map).size();
